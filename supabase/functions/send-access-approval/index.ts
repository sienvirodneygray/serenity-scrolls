...
serve(async (req) => {
  ...
  try {
    ...
    const emailHtml = buildBaseEmail(
      "Your Serenity Scrolls Access Has Been Approved! ✨",
      `
        ...
        <p style="text-align: center;">
          <a href="${accessLink}" class="btn">Access AI Servant</a>
        </p>
        <p>Simply use the email address <strong>${email}</strong> when logging in.</p>
        
        <div class="scripture">
          "The Lord gives strength to his people; the Lord blesses his people with peace."<br>
          <span style="font-size:13px; color:#a0aec0; font-style:normal; margin-top:8px; display:inline-block; font-family: 'Helvetica Neue', Arial, sans-serif;">— Psalm 29:11</span>
        </div>
