...
const features = [
    {
        ...
        description:
            "Responses are tailored to your current emotion, drawing from 96 curated Bible verses to provide comfort, hope, and light.",
    },
    {
        icon: BookOpen,
        title: "96 Curated Bible Verses",
        description:
            "Every response is deeply rooted in Scripture — color-coded across 6 primary emotional states — so you always find the right word.",
    },
    {
        icon: Clock,
        title: "Available 24/7",
        description:
            "Whether it's 3 AM or midday, your Scripture Companion is always ready to listen, reflect, and guide you through the Word.",
    },
];
...
const betaSteps = [
    {
        ...
        description:
            "Enter your email below to instantly register for our exclusive pre-release tester cohort.",
    },
    {
        number: "02",
        icon: Lock,
        ...
        description:
            "Our automated system will authorize your email and issue a secure, passwordless authentication token.",
    },
    {
        number: "03",
        icon: Sparkles,
        title: "Start Testing",
        description:
            "Enter the companion portal, share how you're feeling, and explore scripture-based conversations.",
    },
];
    ...
    const handleBetaSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                ...
                description: "Redirecting you to the AI Scripture Companion...",
            });
    ...
    return (
        <div className="min-h-screen">
                ...
                <div className="relative z-10 container mx-auto px-4 text-center">
                    <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                            Join our exclusive tester community and help shape a spiritual companion that walks alongside you with wisdom, warmth, and the Word of God.
                        </p>
                            ...
                            <Card className="p-6 border-border/80 shadow-xl bg-card/90 backdrop-blur-md">
                                {status === "success" ? (
                                    <div className="text-center space-y-4 py-4">
                                        ...
                                        <h3 className="font-bold text-lg text-green-600">Access Approved!</h3>
                                        <p className="text-sm text-muted-foreground">
                                            Creating your profile and entering the companion portal...
                                        </p>
                                    ...
                                    <form onSubmit={handleBetaSignup} className="space-y-4 text-left">
                                        ...
                                        <p className="text-[11px] text-muted-foreground text-center">
                                            ...
                                            Immediate free trial access granted. No credit card required.
                                        </p>
                                    </form>
                                )}
                            </Card>
            ...
            <section className="py-24 bg-background">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <p className="text-primary font-medium mb-3 tracking-wide uppercase text-sm font-semibold">What It Is</p>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">
                            Scripture Meets Wisdom
                        </h2>
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            The Serenity Scrolls Servant is an AI companion trained to understand your emotions and support your spiritual walk with relevant biblical insights.
                        </p>
                    </div>
            ...
            <section id="how-it-works" className="py-24 bg-muted/30">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <p className="text-primary font-medium mb-3 tracking-wide uppercase text-sm font-semibold">How It Works</p>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">
                            Simple Entry to the Beta
                        </h2>
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            Here is how you join our developer cohort and launch your testing session.
                        </p>
                    </div>
            ...
            <section className="py-24 bg-background">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <p className="text-primary font-medium mb-3 tracking-wide uppercase text-sm font-semibold">Preview</p>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">
                            See It in Action
                        </h2>
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                            Test conversations with the Scripture Companion offer direct encouragement and bible references.
                        </p>
                    </div>
                        ...
                        <Card className="overflow-hidden shadow-xl border-border/50">
                            ...
                            <div className="bg-primary/5 border-b border-border px-6 py-4 flex items-center gap-3">
                                ...
                                <div className="ml-auto flex items-center gap-1.5">
                                    ...
                                    <span className="text-xs text-muted-foreground font-semibold">Online</span>
                                </div>
                            </div>
            ...
            <section className="py-24 bg-muted/30">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <p className="text-primary font-medium mb-3 tracking-wide uppercase text-sm font-semibold">How It Responds</p>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6">
                ...
                <div className="relative z-10 container mx-auto px-4 text-center">
                    <div className="max-w-3xl mx-auto space-y-8">
                        ...
                        <p className="text-xl text-muted-foreground max-w-xl mx-auto leading-relaxed">
                            Sign up today with your email and get immediate access to our closed beta test group.
                        </p>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Help us build a companion that serves and inspires.
                        </p>
                    </div>
                </div>
            </section>
